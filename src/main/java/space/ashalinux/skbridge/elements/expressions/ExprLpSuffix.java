...
public class ExprLpSuffix extends SimpleExpression<String> {
    ...
    protected String[] get(Event e) {
        ...
        if (u == null || u.getCachedData().getMetaData().getSuffix() == null) {
            return null;
        }

        String suffix = u.getCachedData().getMetaData().getSuffix();
        return new String[]{ChatColor.translateAlternateColorCodes('&', suffix)};
    }
